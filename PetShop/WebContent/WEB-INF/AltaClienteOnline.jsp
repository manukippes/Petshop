						...
						<div class="form-group row">
							...
							<!-- Input de contraseña -->
							    ...
							    <div class="col-lg-4 col-md-12" id="contraseniaGroup">
							    	...
							    	<input type="text" class="form-control" name="contrasenia" id="contrasenia" aria-describedby="contraseniaHelp" placeholder="Ingres&aacute; una contrase&ntilde;a">
								</div>
							...
							<!-- Input de contraseña -->
							    ...
							    <div class="col-lg-4 col-md-12" id="contraseniaRepetirGroup">
							    	...
							    	<input type="text" class="form-control" name="contraseniaRepetir" id="contraseniaRepetir" aria-describedby="contraseniaRepetirHelp" placeholder="Repet&iacute; la contrase&ntilde;a">
								</div>
						</div>
						<hr>
		            	<div class="form-group row">
