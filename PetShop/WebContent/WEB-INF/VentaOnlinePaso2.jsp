		 	...
		 	<div class="panel-body">
				...
				<!-- PANEL MODAL DE BUSQUEDA DE CLIENTE -->
					...
					<% 
								...
								total = BigDecimal.valueOf(0,2);
								precio = BigDecimal.valueOf(0,2);
					...
					<div class="modal fade" id="carrito">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="table-responsive">
										<h5 class="text-muted text-center hidden" id="carritoVacio">No hay productos en el carrito</h5>
										<table id="tablaVentaActual" class="table table-striped table-hover tablaVentaActual hidden">
											...
											<tbody>
											<%for(ArrayList<String> producto : productos){
												produ.setIdProducto(Integer.parseInt(producto.get(0)));
												produ = ctrlProducto.getProducto(prod);
												precio = BigDecimal.valueOf(prod.getPrecio());
												cantidad = BigDecimal.valueOf(Double.parseDouble(producto.get(1)));
												total = total.add(cantidad.multiply(precio));
											%>
												<tr>
													<td id="imagen">
														<div class="">
															<img class="img-thumbnail" src="<%=produ.getImagen() %>" width='50px' height='50px'/>
														</div>
													</td>
													<td id="idProducto" class="hidden"><%=produ.getIdProducto()%></td>
													...
													<td>
														<div class="" id="cantidadProductoGroup">
															<input id="cantidadProducto" type="number" class="form-control cantidadProducto" min="0" max="<%=produ.getStock()%>" value="<%=cantidad %>"></input>
														</div>
													</td>
