		            	...
		            	%>
		            		<!-- Input de idUsuario -->
		            	  	...
		            	  	<!-- Input de nombre -->
							    ...
							    <div class="col-lg-6 col-md-12" id="nombreGroup">
							    	...
							    	<input type="text" class="form-control" name="nombre" id="nombre" aria-describedby="nombreHelp" placeholder="Ingres&aacute; el nombre del cliente a modificar" value="<%= cli.getNombre() %>">
								</div>
							...
							<!-- Input de apellido -->
							    ...
							    <div class="col-lg-6 col-md-12" id="apellidoGroup">
							    	...
							    	<input type="text" class="form-control" name="apellido" id="apellido" aria-describedby="apellidoHelp" placeholder="Ingres&aacute; el apellido del cliente a modificar" value="<%= cli.getApellido() %>">
								</div>
						</div>
						<hr>
						...
						<div class="form-group row">
			            	<!-- Input de dni-->
							    ...
							    <div class="col-lg-6 col-md-12" id="dniGroup">
							    	...
							    	<input type="text" class="form-control" name="dni" id="dni" aria-describedby="dniHelp" placeholder="Ingres&aacute; el dni del cliente a modificar" value="<%= cli.getDni() %>">
								</div>
							...
							<!-- Input de direccion -->
							    ...
							    <div class="col-lg-6 col-md-12" id="direccionGroup">
							    	...
							    	<input type="text" min="0"class="form-control" name="direccion" id="direccion" aria-describedby="direccionHelp" placeholder="Ingres&aacute; la direcci&oacute;n del cliente a modificar" value="<%= cli.getDireccion() %>">
								</div>
						</div>
						<hr>
						...
						<div class="form-group row">
							<!-- Input de telefono -->
							    ...
							    <div class="col-lg-6 col-md-12" id="telefonoGroup">
							    	...
							    	<input type="text" class="form-control" name="telefono" id="telefono" aria-describedby="telefonoHelp" placeholder="Ingres&aacute; el tel&eacute;fono, sin guiones, del cliente a modificar" value="<%= cli.getTelefono() %>">
								</div>
			            	...
			            	<!-- Input de email-->
							    ...
							    <div class="col-lg-6 col-md-12" id="emailGroup">
							    	...
							    	<input type="email" class="form-control" name="email" id="email" aria-describedby="emailHelp" placeholder="Ingres&aacute; el email del cliente a modificar" value="<%=emailUsuario %>">
								</div>
						</div>
						<hr>
