...
<body onload="iniciar('turnos');">
	...
	<div class="container panel panel-default colorPanel">
	 	<div class="panel-body">
			<br>
			<br>
			<h4><strong>TURNO ONLINE</strong> - Paso 2 de 2</h4>
			<hr>
			<form action="#" method="post" class="form-horizontal"  id="formTurnosPaso2">
				<div class="container-fluid">
					<div class="container-fluid">
						<div class="form-group">
						<h4><strong class="text-muted">TU TURNO ESTA CASI LISTO, VERIFIC&Aacute; QUE LOS DATOS SEAN CORRECTOS </strong></h4>
							<div class="row ">	
							...
							<div class="row">
								<div class="container-fluid form-group ">
									<div class="col-sm-3 col-xs-12 pull-right">
										<button class="btn btn-primary form-control" id="btnConfirmarTurno"> Finalizar </button>
									</div>	
