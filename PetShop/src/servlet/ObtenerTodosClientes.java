 ...
 */
@WebServlet({ "/ObtenerTodosClientes", "/ObtenertodosClientes", "/obtenerTodosclientes", "/obtenertodosclientes" })
public class ObtenerTodosClientes extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ObtenerTodosClientes() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			usuarios = ctrlUsuario.getTodosUsuariosLike(inputCliente);    			//Consigo los clientes que se asemejan al input
